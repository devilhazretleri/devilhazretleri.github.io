    ...
    return function e(t, n, r) {
        ...
        7: [function(e, t, n) {
            ...
            function r(e, t, n) {
                ...
                var r = n.cache || o.cache
                  , c = r.queryOptions;
                return i.debug("Strategy: cache first [" + e.url + "]", n),
        ...
        8: [function(e, t, n) {
            ...
            function r(e, t, n) {
                ...
                var r = n.cache || o.cache
                  , c = r.queryOptions;
                return i.debug("Strategy: cache only [" + e.url + "]", n),
                i.openCache(n).then(function(t) {
                    return t.match(e, c).then(function(e) {
                        var t = Date.now();
                        if (i.isResponseFresh(e, r.maxAgeSeconds, t))
                            return e
                    })
                })
            }
